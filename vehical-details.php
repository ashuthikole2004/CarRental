...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,duration,message,Status) VALUES(:useremail,:vhid,:fromdate,:duration,:message,:status)";
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="https://www.facebook.com/profile.php?id=100092037468162&mibextid=ZbWKwL"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
		  <a href="https://twitter.com/ShwetaShinde220?t=8Mel-iWAmALtpU63rZ2U6w&s=03"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> 
		  <a href="https://instagram.com/ashu_thikole?igshid=ZDdkNTZiNTM="><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
        </div>
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="duration" placeholder="duration in days" required>
            </div>
            <div class="form-group">
